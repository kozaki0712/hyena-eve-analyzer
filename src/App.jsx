...
export default function App() {
  ...
  const fetchData = async (hall) => {
    ...
    try {
      const res = await fetch(`http://localhost:3001/api/scrape?slug=${hall.slug}`);
      ...
      <div style={S.body}>
        ...
        {tab === "halls" && (
          <div style={S.section}>
            ...
            <div style={{ ...S.row, marginBottom: 20, alignItems: "flex-end" }}>
              ...
              <div><div style={S.label}>アナスロURL slug</div><div style={{ ...S.row, gap: 4 }}><span style={{ color: "#475569", fontSize: 12 }}>ana-slo.com/</span><input style={{ ...S.input, width: 200 }} value={newHallSlug} onChange={e => setNewHallSlug(e.target.value)} placeholder="例: maruhan-shibuya" /></div></div>
              <div>
              ...
              <button style={S.btn("primary")} onClick={addHall}>追加</button>
            </div>
